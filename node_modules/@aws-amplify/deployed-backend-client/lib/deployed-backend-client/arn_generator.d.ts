...
export declare class ArnGenerator {
     ...
     */
    generateArn: (stackResourceSummary: Pick<StackResourceSummary, 'PhysicalResourceId' | 'ResourceType'>, region: string | undefined, accountId: string | undefined) => string | undefined;
    private isArn;
}
