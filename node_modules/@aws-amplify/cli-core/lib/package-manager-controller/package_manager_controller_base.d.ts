...
export declare abstract class PackageManagerControllerBase implements PackageManagerController {
     ...
     */
    constructor(cwd: string, executable: string, binaryRunner: string, initDefault: string[], installCommand: string, fsp?: typeof _fsp, path?: _path.PlatformPath, execa?: typeof _execa, executeWithDebugLogger?: (cwd: string, executable: string, args?: readonly string[] | undefined, execa?: typeof _execa, options?: Options<"utf8"> | undefined) => ExecaChildProcess<string>, existsSync?: typeof _existsSync);
    /**
