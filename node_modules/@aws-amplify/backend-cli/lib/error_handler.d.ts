 ...
 */
export declare const attachUnhandledExceptionListeners: () => void;
/**
 ...
 */
export declare const generateCommandFailureHandler: (parser: Argv) => (message: string, error: Error) => void;
