...
export declare class FileWatchingSandbox extends EventEmitter implements Sandbox {
     ...
     */
    constructor(backendIdSandboxResolver: BackendIdSandboxResolver, executor: AmplifySandboxExecutor, cfnClient: CloudFormationClient, printer: Printer, open?: typeof _open);
    /**
     * @inheritdoc
     */
